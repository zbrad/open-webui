...
# Tested with cu117 for CUDA 11 and cu121 for CUDA 12; this fork targets cu133
...
RUN set -e; \
    ...
    # GB10 (Grace, aarch64) targets cu133 nightly rather than upstream's
    # torch<=2.9.1 ARM pin (#21349) -- that pin is for the RPi4 Cortex-A72
    # SIGILL specifically, a much weaker/older ARM core than Grace.
    ARCH="$(uname -m)"; \
